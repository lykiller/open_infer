...
def move_need_label_images():
    if_move_dir_list = [
        r"D:\dataset\terrain_data\videos_0711\sample_images\error_masks",
        r"D:\dataset\terrain_data\videos_error_0625\sample_images\error_masks",
        r"E:\yinchuan4\sample_images\error_masks",
        r"E:\yinchuan3\sample_images\error_masks",
        r"E:\yinchuan2\sample_images\error_masks",
        r"E:\yinchuan1\sample_images\error_masks",
        r"E:\yinchuan0\sample_images\error_masks",
    ]

    dst_path = r"D:\dataset\terrain_data\need_label_dianwo_20230822"
    mkdir(dst_path)
